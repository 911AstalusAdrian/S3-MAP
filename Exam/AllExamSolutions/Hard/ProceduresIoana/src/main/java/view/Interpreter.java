...
public class Interpreter {
    public static void main(String[] args) {
        ...
        IStack<IDictionary<String, IValue>> symTableStack1 = new MyStack<>();
        symTableStack1.push(dic1);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable1 = new MyDictionary<>();
        ...
        ProgramState state1 = new ProgramState(stack1, symTableStack1, out1, ex1, fileTable1, heap1, procTable1);
        try {
        ...
        IStack<IDictionary<String, IValue>> symTableStack2 = new MyStack<>();
        symTableStack2.push(dic2);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable2 = new MyDictionary<>();
        ...
        ProgramState state2 = new ProgramState(stack2, symTableStack2, out2, ex2, fileTable2, heap2, procTable2);
        try {
        ...
        IStack<IDictionary<String, IValue>> symTableStack3 = new MyStack<>();
        symTableStack3.push(dic3);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable3 = new MyDictionary<>();
        ...
        ProgramState state3 = new ProgramState(stack3, symTableStack3, out3, ex3, fileTable3, heap3, procTable3);
        try {
        ...
        IStack<IDictionary<String, IValue>> symTableStack4 = new MyStack<>();
        symTableStack4.push(dic4);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable4 = new MyDictionary<>();
        ...
        ProgramState state4 = new ProgramState(stack4,symTableStack4, out4, ex4, fileTable4, heap4, procTable4);
        try {
        ...
        IStack<IDictionary<String, IValue>> symTableStack5 = new MyStack<>();
        symTableStack5.push(dic5);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable5 = new MyDictionary<>();
        ...
        ProgramState state5 = new ProgramState(stack5,symTableStack5, out5, ex5, fileTable5, heap5, procTable5);
        try {
        ...
        IStack<IDictionary<String, IValue>> symTableStack6 = new MyStack<>();
        symTableStack6.push(dic6);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable6 = new MyDictionary<>();
        ...
        ProgramState state6 = new ProgramState(stack6, symTableStack6, out6, ex6, fileTable6, heap6, procTable6);
        try {
        ...
        IStack<IDictionary<String, IValue>> symTableStack7 = new MyStack<>();
        symTableStack7.push(dic7);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable7 = new MyDictionary<>();
                        ...
                        new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v"))),
                                new CompStatement(new HeapWriteStatement("v", new ValueExpression(new IntValue(30))),
                                        new PrintStatement(new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v")),
                                                new ValueExpression(new IntValue(5)), '+'))))));
        ProgramState state7 = new ProgramState(stack7, symTableStack7, out7, ex7, fileTable7, heap7, procTable7);
        ...
        IStack<IDictionary<String, IValue>> symTableStack8 = new MyStack<>();
        symTableStack8.push(dic8);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable8 = new MyDictionary<>();
        ...
        ProgramState state8 = new ProgramState(stack8, symTableStack8, out8, ex8, fileTable8, heap8, procTable8);
        try {
        ...
        IStack<IDictionary<String, IValue>> symTableStack9 = new MyStack<>();
        symTableStack9.push(dic9);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable9 = new MyDictionary<>();
        ...
        ProgramState state9 = new ProgramState(stack9,symTableStack9, out9, ex9, fileTable9, heap9, procTable9);
        try {
        ...
        IStack<IDictionary<String, IValue>> symTableStack10 = new MyStack<>();
        symTableStack10.push(dic10);
        ...
        IDictionary<String, Pair<List<String>, IStatement>> procTable10 = new MyDictionary<>();
        ...
        ProgramState state10 = new ProgramState(stack10,symTableStack10, out10, ex10, fileTable10, heap10, procTable10);
        try {
