...
public class ControllerPicker {
    ...
    private ObservableList<IStatement> getStatements() {
        ...
        IStatement ex12 = compound(new VariableDeclarationStatement("v1", new ReferenceType(new IntType())),
                new VariableDeclarationStatement("cnt", new IntType()), new HeapNewStatement("v1", new ValueExpression(new IntValue(2))),
                new NewSemaphoreStatement("cnt", new HeapReadingExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(1))),
