...
public class ProgramState {
    ...
    private final MyIToySemaphoreTable toySemaphoreTable;
    private int id;
    ...
    public MyIToySemaphoreTable getToySemaphoreTable() { return toySemaphoreTable; }
