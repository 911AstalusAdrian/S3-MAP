...
public class Interpreter {
    public static void main(String[] args) {
        ...
        IBarrierTable barrierTable1 = new MyBarrierTable();
        try {
            ex1.typeCheck(typeEnv1);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        ProgramState state1 = new ProgramState(stack1, dic1, out1, ex1, fileTable1, heap1, barrierTable1);
        try {
        ...
        IBarrierTable barrierTable2 = new MyBarrierTable();
        ...
        ProgramState state2 = new ProgramState(stack2, dic2, out2, ex2, fileTable2, heap2, barrierTable2);
        try {
        ...
        IBarrierTable barrierTable3 = new MyBarrierTable();
        ...
        ProgramState state3 = new ProgramState(stack3, dic3, out3, ex3, fileTable3, heap3, barrierTable3);
        try {
        ...
        IBarrierTable barrierTable4 = new MyBarrierTable();
        ...
        ProgramState state4 = new ProgramState(stack4, dic4, out4, ex4, fileTable4, heap4, barrierTable4);
        try {
        ...
        IBarrierTable barrierTable5 = new MyBarrierTable();
        ...
        ProgramState state5 = new ProgramState(stack5, dic5, out5, ex5, fileTable5, heap5, barrierTable5);
        try {
        ...
        IBarrierTable barrierTable6 = new MyBarrierTable();
        ...
        ProgramState state6 = new ProgramState(stack6, dic6, out6, ex6, fileTable6, heap6, barrierTable6);
        try {
        ...
        IBarrierTable barrierTable7 = new MyBarrierTable();
                        ...
                        new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v"))),
                                new CompStatement(new HeapWriteStatement("v", new ValueExpression(new IntValue(30))),
                                        new PrintStatement(new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v")),
                                                new ValueExpression(new IntValue(5)), '+'))))));
        ProgramState state7 = new ProgramState(stack7, dic7, out7, ex7, fileTable7, heap7, barrierTable7);
        ...
        IBarrierTable barrierTable8 = new MyBarrierTable();
        ...
        ProgramState state8 = new ProgramState(stack8, dic8, out8, ex8, fileTable8, heap8, barrierTable8);
        try {
        ...
        IBarrierTable barrierTable9 = new MyBarrierTable();
        ...
        ProgramState state9 = new ProgramState(stack9, dic9, out9, ex9, fileTable9, heap9, barrierTable9);
        try {
        ...
        IBarrierTable barrierTable10 = new MyBarrierTable();
        ...
        ProgramState state10 = new ProgramState(stack10, dic10, out10, ex10, fileTable10, heap10, barrierTable10);
        try {
