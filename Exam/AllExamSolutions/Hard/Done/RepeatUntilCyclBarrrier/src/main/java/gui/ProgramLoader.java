...
import model.statements.multithreadingStatements.AwaitStatement;
import model.statements.multithreadingStatements.ForkStatement;
import model.statements.multithreadingStatements.NewBarrierStatement;
...
public class ProgramLoader {
    ...
    private ObservableList<IStatement> getPrograms(){
        ...
        IStatement ex11 = new CompStatement(new VarDeclaration("v", IntType.T), new CompStatement(new VarDeclaration("x", IntType.T),
                new CompStatement(new VarDeclaration("y", IntType.T),
                        new CompStatement(new Assignment("v", new ValueExpression(new IntValue(0))),
                                new CompStatement(new RepeatUntilStatement(new CompStatement(new ForkStatement(
                                        new CompStatement(new PrintStatement(new VariableExpression("v")),
                                                new Assignment("v", new ArithmeticExpression(new VariableExpression("v"),
                                                        new ValueExpression(new IntValue(1)), '-')))), new Assignment("v", new ArithmeticExpression(new VariableExpression("v"),
                                        new ValueExpression(new IntValue(1)), '+'))), new RelationalExpression(new VariableExpression("v"), new ValueExpression(new IntValue(3)), "==")),
                                        new CompStatement(new Assignment("x", new ValueExpression(new IntValue(1))), new CompStatement(new NopStatement(), new CompStatement(new Assignment("y",
                                                new ValueExpression(new IntValue(3))), new CompStatement(new NopStatement(), new PrintStatement(new ArithmeticExpression(new VariableExpression("v"),
                                                new ValueExpression(new IntValue(10)), '*')))))))))));

        IStatement ex12 = new CompStatement(new VarDeclaration("v1", new ReferenceType(IntType.T)), new CompStatement(new VarDeclaration("v2", new ReferenceType(IntType.T)), new CompStatement(new VarDeclaration("v3", new ReferenceType(IntType.T)), new CompStatement(new VarDeclaration("cnt", IntType.T), new CompStatement(new AllocateStatement("v1", new ValueExpression(new IntValue(2))), new CompStatement(new AllocateStatement("v2", new ValueExpression(new IntValue(3))),new CompStatement(new AllocateStatement("v3", new ValueExpression(new IntValue(4))), new CompStatement(new NewBarrierStatement("cnt", new HeapReadExpression(new VariableExpression("v2"))), new CompStatement(new ForkStatement(new CompStatement(new CompStatement(new AwaitStatement("cnt"), new HeapWriteStatement("v1", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)), '*'))),new PrintStatement(new HeapReadExpression(new VariableExpression("v1"))))), new CompStatement(new ForkStatement(new CompStatement(new CompStatement(new AwaitStatement("cnt"), new HeapWriteStatement("v2", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v2")), new ValueExpression(new IntValue(10)), '*'))), new CompStatement(new HeapWriteStatement("v2", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v2")), new ValueExpression(new IntValue(10)), '*')), new PrintStatement(new HeapReadExpression(new VariableExpression("v2")))))), new CompStatement(new AwaitStatement("cnt"), new PrintStatement(new HeapReadExpression(new VariableExpression("v3"))))))))))))));

        return FXCollections.observableArrayList(ex1, ex2, ex3, ex4, ex5, ex6, ex7, ex8, ex9, ex10, ex11, ex12);
    }
    ...
    private Controller initializeProgram(IStatement program){
        ...
        ProgramState state = new ProgramState(stack, dic, out, program, fileTable, heap, barrierTable);
        try {
