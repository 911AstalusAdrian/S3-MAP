...
public class ProgramState {
    ...
    private final ITable<Integer> latchTable;
    private IStatement originalProgram;
    private static AtomicInteger global_id = new AtomicInteger(1);
    private final int id;

    public ProgramState(IStack<IStatement> stk, IDictionary<String, IValue> symtbl, IList<IValue> ot, IStatement prg, IDictionary<StringValue, BufferedReader> fTable, IHeap<IValue> heap, ITable<Integer> latchTable) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
    ...
    public ITable<Integer> getLatchTable(){return latchTable;}
