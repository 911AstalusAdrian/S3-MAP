...
public class Interpreter {
    public static void main(String[] args) {
        ...
        ITable<Integer> latchTable1 = new MyLatchTable<>();
        ...
        ProgramState state1 = new ProgramState(stack1, dic1, out1, ex1, fileTable1, heap1, latchTable1);
        try {
        ...
        ITable<Integer> latchTable2 = new MyLatchTable<>();
        ...
        ProgramState state2 = new ProgramState(stack2, dic2, out2, ex2, fileTable2, heap2, latchTable2);
        try {
        ...
        ITable<Integer> latchTable3 = new MyLatchTable<>();
        ...
        ProgramState state3 = new ProgramState(stack3, dic3, out3, ex3, fileTable3, heap3, latchTable3);
        try {
        ...
        ITable<Integer> latchTable4 = new MyLatchTable<>();
        ...
        ProgramState state4 = new ProgramState(stack4, dic4, out4, ex4, fileTable4, heap4, latchTable4);
        try {
        ...
        ITable<Integer> latchTable5 = new MyLatchTable<>();
        ...
        ProgramState state5 = new ProgramState(stack5, dic5, out5, ex5, fileTable5, heap5, latchTable5);
        try {
        ...
        ITable<Integer> latchTable6 = new MyLatchTable<>();
        ...
        ProgramState state6 = new ProgramState(stack6, dic6, out6, ex6, fileTable6, heap6, latchTable6);
        try {
        ...
        ITable<Integer> latchTable7 = new MyLatchTable<>();
                        ...
                        new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v"))),
                                new CompStatement(new HeapWriteStatement("v", new ValueExpression(new IntValue(30))),
                                        new PrintStatement(new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v")),
                                                new ValueExpression(new IntValue(5)), '+'))))));
        ProgramState state7 = new ProgramState(stack7, dic7, out7, ex7, fileTable7, heap7, latchTable7);
        ...
        ITable<Integer> latchTable8 = new MyLatchTable<>();
        ...
        ProgramState state8 = new ProgramState(stack8, dic8, out8, ex8, fileTable8, heap8, latchTable8);
        try {
        ...
        ITable<Integer> latchTable9 = new MyLatchTable<>();
        ...
        ProgramState state9 = new ProgramState(stack9, dic9, out9, ex9, fileTable9, heap9, latchTable9);
        try {
        ...
        ITable<Integer> latchTable10 = new MyLatchTable<>();
        ...
        ProgramState state10 = new ProgramState(stack10, dic10, out10, ex10, fileTable10, heap10, latchTable10);
        try {
