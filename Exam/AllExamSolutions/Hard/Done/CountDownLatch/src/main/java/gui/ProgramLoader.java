...
import model.statements.multithreadingStatements.CountDownStatement;
import model.statements.multithreadingStatements.ForkStatement;
import model.statements.multithreadingStatements.NewLatchStatement;
...
public class ProgramLoader {
    ...
    private ObservableList<IStatement> getPrograms(){
        ...
        IStatement ex11 = new CompStatement(new VarDeclaration("v1", new ReferenceType(IntType.T)), new CompStatement(new VarDeclaration("v2", new ReferenceType(IntType.T)), new CompStatement(new VarDeclaration("v3", new ReferenceType(IntType.T)), new CompStatement(new VarDeclaration("cnt", IntType.T), new CompStatement(new AllocateStatement("v1", new ValueExpression(new IntValue(2))), new CompStatement(new AllocateStatement("v2", new ValueExpression(new IntValue(3))), new CompStatement(new AllocateStatement("v3", new ValueExpression(new IntValue(4))), new CompStatement(new NewLatchStatement("cnt", new HeapReadExpression(new VariableExpression("v2"))), new CompStatement(new ForkStatement(new CompStatement(new HeapWriteStatement("v1", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)), '*')), new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v1"))), new CompStatement(new CountDownStatement("cnt"),  new ForkStatement(new CompStatement(new HeapWriteStatement("v2", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v2")), new ValueExpression(new IntValue(10)), '*')), new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v2"))), new CompStatement(new CountDownStatement("cnt"), new ForkStatement(new CompStatement(new HeapWriteStatement("v3", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v3")), new ValueExpression(new IntValue(10)), '*')), new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v3"))), new CountDownStatement("cnt")))))))))))), new CompStatement(new AwaitStatement("cnt"), new CompStatement(new PrintStatement(new ValueExpression(new IntValue(100))), new CompStatement(new CountDownStatement("cnt"), new PrintStatement(new ValueExpression(new IntValue(100)))))))))))))));
        return FXCollections.observableArrayList(ex1, ex2, ex3, ex4, ex5, ex6, ex7, ex8, ex9, ex10, ex11);
    }
    ...
    private Controller initializeProgram(IStatement program){
        ...
        ITable<Integer> latchTable = new MyLatchTable<>();
        ...
        ProgramState state = new ProgramState(stack, dic, out, program, fileTable, heap, latchTable);
        try {
