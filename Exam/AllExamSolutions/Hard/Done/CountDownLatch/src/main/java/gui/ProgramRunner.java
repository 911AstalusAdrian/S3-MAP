...
public class ProgramRunner implements Observer {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> latchTableAddr;

    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> latchCount;
    ...
    private void setLatchTable() {
        ...
        latchTableAddr.setCellValueFactory(cellData -> new SimpleStringProperty(Integer.toString(cellData.getValue().getKey())));
        latchCount.setCellValueFactory(cellData -> new SimpleStringProperty(Integer.toString(cellData.getValue().getValue())));
        latchTableList.addAll(cont.getRepository().getProgramList().get(0).getLatchTable().getContent().entrySet());
