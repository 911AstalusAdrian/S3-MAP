...
public class Interpreter {
    public static void main(String[] args) {
        ...
        ISemaphore semaphoreTable1 = new MyCountSemaphore();
        ...
        ProgramState state1 = new ProgramState(stack1, dic1, out1, ex1, fileTable1, heap1, semaphoreTable1);
        try {
        ...
        ISemaphore semaphoreTable2 = new MyCountSemaphore();
        ...
        ProgramState state2 = new ProgramState(stack2, dic2, out2, ex2, fileTable2, heap2, semaphoreTable2);
        try {
        ...
        ISemaphore semaphoreTable3 = new MyCountSemaphore();
        ...
        ProgramState state3 = new ProgramState(stack3, dic3, out3, ex3, fileTable3, heap3, semaphoreTable3);
        try {
        ...
        ISemaphore semaphoreTable4 = new MyCountSemaphore();
        ...
        ProgramState state4 = new ProgramState(stack4, dic4, out4, ex4, fileTable4, heap4, semaphoreTable4);
        try {
        ...
        ISemaphore semaphoreTable5 = new MyCountSemaphore();
        ...
        ProgramState state5 = new ProgramState(stack5, dic5, out5, ex5, fileTable5, heap5, semaphoreTable5);
        try {
        ...
        ISemaphore semaphoreTable6 = new MyCountSemaphore();
        ...
        ProgramState state6 = new ProgramState(stack6, dic6, out6, ex6, fileTable6, heap6, semaphoreTable6);
        try {
        ...
        ISemaphore semaphoreTable7 = new MyCountSemaphore();
                        ...
                        new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v"))),
                                new CompStatement(new HeapWriteStatement("v", new ValueExpression(new IntValue(30))),
                                        new PrintStatement(new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v")),
                                                new ValueExpression(new IntValue(5)), '+'))))));
        ProgramState state7 = new ProgramState(stack7, dic7, out7, ex7, fileTable7, heap7, semaphoreTable7);
        ...
        ISemaphore semaphoreTable8 = new MyCountSemaphore();
        ...
        ProgramState state8 = new ProgramState(stack8, dic8, out8, ex8, fileTable8, heap8, semaphoreTable8);
        try {
        ...
        ISemaphore semaphoreTable9 = new MyCountSemaphore();
        ...
        ProgramState state9 = new ProgramState(stack9, dic9, out9, ex9, fileTable9, heap9, semaphoreTable9);
        try {
        ...
        ISemaphore semaphoreTable10 = new MyCountSemaphore();
        ...
        ProgramState state10 = new ProgramState(stack10, dic10, out10, ex10, fileTable10, heap10, semaphoreTable10);
        try {
