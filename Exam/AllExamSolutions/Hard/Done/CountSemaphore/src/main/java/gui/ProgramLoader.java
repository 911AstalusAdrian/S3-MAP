...
import model.statements.multithreadingStatements.AcquireSemaphoreStatement;
import model.statements.multithreadingStatements.CreateSemaphoreStatement;
import model.statements.multithreadingStatements.ForkStatement;
import model.statements.multithreadingStatements.ReleaseSemaphoreStatement;
...
public class ProgramLoader {
    ...
    private ObservableList<IStatement> getPrograms(){
        ...
        IStatement ex11 = new CompStatement(new VarDeclaration("v1", new ReferenceType(IntType.T)), new CompStatement(new VarDeclaration("cnt", IntType.T), new CompStatement(new AllocateStatement("v1", new ValueExpression(new IntValue(1))), new CompStatement(new CreateSemaphoreStatement("cnt", new HeapReadExpression(new VariableExpression("v1"))), new CompStatement(new ForkStatement(new CompStatement(new AcquireSemaphoreStatement("cnt"), new CompStatement(new HeapWriteStatement("v1", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)), '*')), new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v1"))), new ReleaseSemaphoreStatement("cnt"))))), new CompStatement(new ForkStatement(new CompStatement(new AcquireSemaphoreStatement("cnt"), new CompStatement(new HeapWriteStatement("v1", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)), '*')), new CompStatement(new HeapWriteStatement("v1", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(2)), '*')), new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v1"))), new ReleaseSemaphoreStatement("cnt")))))), new CompStatement(new AcquireSemaphoreStatement("cnt"), new CompStatement(new PrintStatement(new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(1)), '-')), new ReleaseSemaphoreStatement("cnt")))))))));
    ...
    private Controller initializeProgram(IStatement program){
        ...
        ISemaphore semaphoreTable = new MyCountSemaphore();
        ...
        ProgramState state = new ProgramState(stack, dic, out, program, fileTable, heap, semaphoreTable);
        try {
