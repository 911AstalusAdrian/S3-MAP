...
public class CreateSemaphoreStatement implements IStatement {
    ...
    public CreateSemaphoreStatement(String var_name, IExpression exp) {
    ...
    public ProgramState execute(ProgramState state) throws Exception {
        ...
        int newEntry = state.getSemaphoreTable().allocate(((IntValue)expval).getWrappedValue());
    ...
    public IStatement deep_copy() {
        return new CreateSemaphoreStatement(var_name, exp);
    }
