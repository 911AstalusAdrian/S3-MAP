...
import model.statements.multithreadingStatements.LockStatement;
import model.statements.multithreadingStatements.NewLockStatement;
import model.statements.multithreadingStatements.UnlockStatement;
...
public class ProgramLoader {
    ...
    private ObservableList<IStatement> getPrograms(){
        ...
        IStatement ex11 = new CompStatement(new VarDeclaration("v1", new ReferenceType(IntType.T)), new CompStatement(new VarDeclaration("v2", new ReferenceType(IntType.T)), new CompStatement(new AllocateStatement("v1", new ValueExpression(new IntValue(20))), new CompStatement(new AllocateStatement("v2", new ValueExpression(new IntValue(30))), new CompStatement(new NewLockStatement("x"), new CompStatement(new ForkStatement(new CompStatement(new ForkStatement(new CompStatement(new CompStatement(new LockStatement("x"), new HeapWriteStatement("v1", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(1)), '-'))), new UnlockStatement("x"))), new CompStatement(new CompStatement(new LockStatement("x"), new HeapWriteStatement("v1", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(1)), '+'))), new UnlockStatement("x")))), new CompStatement(new ForkStatement(new CompStatement(new ForkStatement(new HeapWriteStatement("v2", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v2")), new ValueExpression(new IntValue(1)), '+'))), new CompStatement(new HeapWriteStatement("v2", new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v2")), new ValueExpression(new IntValue(1)), '+')), new UnlockStatement("x")))), new CompStatement(new NopStatement(), new CompStatement(new NopStatement(), new CompStatement(new NopStatement(), new CompStatement(new NopStatement(), new CompStatement(new NopStatement(), new CompStatement(new NopStatement(), new CompStatement(new NopStatement(), new CompStatement(new NopStatement(), new CompStatement(new NopStatement(), new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v1"))), new PrintStatement(new HeapReadExpression(new VariableExpression("v2"))))))))))))))))))));

        IStatement ex12 = new CompStatement(new VarDeclaration("v", IntType.T), new CompStatement(new Assignment("v", new ValueExpression(new IntValue(20))), new CompStatement(new ForStatement(new Assignment("v", new ValueExpression(new IntValue(0))), new RelationalExpression(new VariableExpression("v"), new ValueExpression(new IntValue(3)), "<"), new ForkStatement(new CompStatement(new PrintStatement(new VariableExpression("v")), new Assignment("v", new ArithmeticExpression(new VariableExpression("v"), new ValueExpression(new IntValue(1)), '+')))), new Assignment("v", new ArithmeticExpression(new VariableExpression("v"), new ValueExpression(new IntValue(1)), '+'))), new PrintStatement(new ArithmeticExpression(new VariableExpression("v"), new ValueExpression(new IntValue(10)), '*')))));
    ...
    private Controller initializeProgram(IStatement program){
        ...
        ITable<Integer> lockTable = new MyLockTable<>();
        ...
        ProgramState state = new ProgramState(stack, dic, out, program, fileTable, heap, lockTable);
        try {
