...
public class Interpreter {
    public static void main(String[] args) {
        ...
        ITable<Integer> lockTable1 = new MyLockTable<>();
        ...
        ProgramState state1 = new ProgramState(stack1, dic1, out1, ex1, fileTable1, heap1, lockTable1);
        try {
        ...
        ITable<Integer> lockTable2 = new MyLockTable<>();
        ...
        ProgramState state2 = new ProgramState(stack2, dic2, out2, ex2, fileTable2, heap2, lockTable2);
        try {
        ...
        ITable<Integer> lockTable3 = new MyLockTable<>();
        ...
        ProgramState state3 = new ProgramState(stack3, dic3, out3, ex3, fileTable3, heap3, lockTable3);
        try {
        ...
        ITable<Integer> lockTable4 = new MyLockTable<>();
        ...
        ProgramState state4 = new ProgramState(stack4, dic4, out4, ex4, fileTable4, heap4, lockTable4);
        try {
        ...
        ITable<Integer> lockTable5 = new MyLockTable<>();
        ...
        ProgramState state5 = new ProgramState(stack5, dic5, out5, ex5, fileTable5, heap5, lockTable5);
        try {
        ...
        ITable<Integer> lockTable6 = new MyLockTable<>();
        ...
        ProgramState state6 = new ProgramState(stack6, dic6, out6, ex6, fileTable6, heap6, lockTable6);
        try {
        ...
        ITable<Integer> lockTable7 = new MyLockTable<>();
                        ...
                        new CompStatement(new PrintStatement(new HeapReadExpression(new VariableExpression("v"))),
                                new CompStatement(new HeapWriteStatement("v", new ValueExpression(new IntValue(30))),
                                        new PrintStatement(new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v")),
                                                new ValueExpression(new IntValue(5)), '+'))))));
        ProgramState state7 = new ProgramState(stack7, dic7, out7, ex7, fileTable7, heap7, lockTable7);
        ...
        ITable<Integer> lockTable8 = new MyLockTable<>();
        ...
        ProgramState state8 = new ProgramState(stack8, dic8, out8, ex8, fileTable8, heap8, lockTable8);
        try {
        ...
        ITable<Integer> lockTable9 = new MyLockTable<>();
        ...
        ProgramState state9 = new ProgramState(stack9, dic9, out9, ex9, fileTable9, heap9, lockTable9);
        try {
        ...
        ITable<Integer> lockTable10 = new MyLockTable<>();
        ...
        ProgramState state10 = new ProgramState(stack10, dic10, out10, ex10, fileTable10, heap10, lockTable10);
        try {
